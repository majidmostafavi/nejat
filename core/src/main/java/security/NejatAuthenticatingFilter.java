...
/**
 * AuthenticatingFilter to control the login process ( Shiro )
 * Created by majid on 6/22/16.
 */
public class NejatAuthenticatingFilter extends AuthenticatingFilter {
    ...
    private static final Logger log = LoggerFactory.getLogger(NejatAuthenticatingFilter.class);
    ...
    public NejatAuthenticatingFilter() {
        ...
        if (isLoginRequest(request, response)) {
            if (isLoginSubmission(request, response)) {
                ...
                if (log.isTraceEnabled()) {
                 ...
                 System.out.println("#### allow them to see login page");
    ...
    protected boolean onLoginSuccess(AuthenticationToken token, Subject subject,
         ...
         System.out.println("#### on login seccess");
    ...
    protected boolean onLoginFailure(AuthenticationToken token, AuthenticationException e,
         ...
         System.out.println("#### on login failed");
